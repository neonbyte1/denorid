...
export class GatewayTimeoutException extends HttpException {
  /**
   * Instantiate an `GatewayTimeoutException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 504.
   ...
   * - `message`: the string `"Gateway Timeout"` by default; override this by supplying a string
