...
export class PreconditionRequiredException extends HttpException {
  /**
   * Instantiate an `PreconditionRequiredException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 428.
   ...
   * - `message`: the string `"Precondition Required"` by default; override this by supplying a string
