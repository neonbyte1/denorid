...
export class ProxyAuthenticationRequiredException extends HttpException {
  /**
   * Instantiate an `ProxyAuthenticationRequiredException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 407.
   ...
   * - `message`: the string `"Proxy Authentication Required"` by default; override this by supplying a string
