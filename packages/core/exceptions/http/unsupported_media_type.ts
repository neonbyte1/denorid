...
export class UnsupportedMediaTypeException extends HttpException {
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 415.
   ...
   * - `message`: the string `"Unsupported Media Type"` by default; override this by supplying a string
  ...
  public constructor(
    ...
    const { description, httpExceptionOptions } = HttpException
      .extractDescriptionAndOptionsFrom(
        descriptionOrOptions ?? STATUS_TEXT[StatusCode.UnsupportedMediaType],
      );
