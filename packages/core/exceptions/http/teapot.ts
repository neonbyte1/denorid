...
/**
 * Defines an HTTP exception for *I'm a Tepot* type errors.
 */
export class TeapotException extends HttpException {
  /**
   * Instantiate an `TeapotException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 418.
   ...
   * - `message`: the string `"I Am A Teapot"` by default; override this by supplying a string
