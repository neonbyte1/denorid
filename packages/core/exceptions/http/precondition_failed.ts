...
export class PreconditionFailedException extends HttpException {
  /**
   * Instantiate an `PreconditionFailedException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 412.
   ...
   * - `message`: the string `"Precondition Failed"` by default; override this by supplying a string
