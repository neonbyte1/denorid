...
/**
 * Defines an HTTP exception for *Upgrade Required* type errors.
 */
export class UpgradeRequiredException extends HttpException {
  /**
   * Instantiate an `UpgradeRequiredException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 426.
   ...
   * - `statusCode`: this will be the value 426.
   * - `message`: the string `"Unpgrade Required"` by default; override this by supplying a string
