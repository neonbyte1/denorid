...
export class TooEarlyException extends HttpException {
  /**
   * Instantiate an `TooEarlyException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 425.
   ...
   * - `message`: the string `"Too Early"` by default; override this by supplying a string
