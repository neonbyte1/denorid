...
export class ExpectationFailedException extends HttpException {
  /**
   * Instantiate an `ExpectationFailedException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 417.
   ...
   * - `message`: the string `"Expectation Failed"` by default; override this by supplying a string
