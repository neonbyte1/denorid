...
export class FailedDependencyException extends HttpException {
  /**
   * Instantiate an `FailedDependencyException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 424.
   ...
   * - `message`: the string `"Failed Dependency"` by default; override this by supplying a string
