...
/**
 * Defines an HTTP exception for *Insufficient Storage* type errors.
 */
export class InsufficientStorageException extends HttpException {
  /**
   * Instantiate an `InsufficientStorageException` exception.
   *
   * @example
   * ```ts
   ...
   *
   * @usageNotes
   * The HTTP response status wll be 507.
   ...
   * - `statusCode`: this will be the value 507.
   * - `message`: the string `"Insufficient Storage"` by default; override this by supplying a string
